...
- GPU Access:
  - NERSC generously provided us 30 training accounts with GPU access for this course, which should be enough to cover everyone in this course. Please follow the procedure:
    - **If you have a NERSC account and have GPU access**: Then there's nothing you need to do
    ...
    - **If you do not have a NERSC account**: please log into this website (https://iris.nersc.gov/train) to register for the training account. The training code will be sent separately. The training account should already have GPU access.
