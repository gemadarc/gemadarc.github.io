...
In Einstein's description of gravity, any mass bends space-time. Thus, even the path of a massless particle like a photon, i.e. light, gets bent. This can result in observing the same object multiple times. 
  ...
  galaxy.pdf:        The stars move as fast at the edge of the galaxy as furher in.
  
  two_pictures.pdf:  Multiple images of Multiple images of the same object are created through the bending of light.
  
  einstein_cross.pdf: Spectral analysis shows that the five images show the same object. 
...
The observation of multiple images of far away objects makes it possible to estimate the amount of mass between the far away object and us. Many observations have to be combinded to create a map of the dark mass. In the end, about
  ...
  dm_map.pdf: A Map of dark matter
  
  bullet.pdf: Two galaxy clusters collided and the visible matter interacted to form the "bullet cluster". The dark matter     components of the two clusters  did not interact and separated again. They were mapped and are shown in blue.
